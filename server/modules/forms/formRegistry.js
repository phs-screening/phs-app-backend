const formRegistry = {
  ...
  hsg: { key: 'hsg', title: 'Healthier SG', collection: 'hsgForm', patientMarker: 'hsgForm' },
  lungFunction: {
    key: 'lungFunction',
    title: 'Lung Function',
  ...
  gynae: { key: 'gynae', title: 'Gynae', collection: 'gynaeForm', patientMarker: 'gynaeForm' },
  podiatry: {
    key: 'podiatry',
    title: 'Podiatry',
  ...
  hpv: { key: 'hpv', title: 'HPV', collection: 'hpvForm', patientMarker: 'hpvForm' },
  audiometry: {
    key: 'audiometry',
    title: 'Audiometry',
  ...
  hxNss: { key: 'hxNss', title: 'History NSS', collection: 'hxNssForm', patientMarker: 'hxNssForm' },
  hxSocial: {
    key: 'hxSocial',
  ...
  geriWh: { key: 'geriWh', title: 'Geri WH', collection: 'geriWhForm', patientMarker: 'geriWhForm' },
  geriInter: {
    key: 'geriInter',
    title: 'Geri Inter',
...
module.exports = { formRegistry, getFormDefinition, getFormInfo, getFormRegistryInfo };
